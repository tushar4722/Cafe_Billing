        ...
        <div class="col-lg-8  p-field">
                ...
                <div class="card-body bg-dark d-flex" id='prod-list'>
                    <div class="col-md-3">
                        <div class="w-100 pr-0 bg-white" id="cat-list">
                            <b>Category</b>
                            <hr>
                            <div class="card bg-info mx-3 mb-2 cat-item" style="height:auto !important;" data-id = 'all'>
                                <div class="card-body">
                            ...
                            ?>
                            <div class="card bg-info mx-3 mb-2 cat-item" style="height:auto !important;" data-id = '<?php echo $row['id'] ?>'>
                                <div class="card-body">
                                    <span><b class="text-white">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="card bg-info prod-item" data-json = '<?php echo json_encode($row) ?>' data-category-id="<?php echo $row['category_id'] ?>">
                                    <div class="card-body">
                                        <span><b class="text-white">
                                            <?php echo $row['name'] ?>
                                        </b></span>
            ...
            <div class="card-footer bg-dark  border-primary">
                <div class="row justify-content-center">
                    <div class="btn btn btn-sm col-sm-3 btn-info mr-2" type="button" id="pay">Pay</div>
                    <div class="btn btn btn-sm col-sm-3 btn-info" type="button" id="save_order">Pay later</div>
                </div>
            </div>
            </div>      			
        </div>
...
<div class="modal fade" id="pay_modal" role='dialog'>
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-info btn-sm"  form="manage-order">Pay</button>
