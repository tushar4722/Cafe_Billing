			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Orders </b>
						<span class="float:right"><a class="btn btn-info btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_order">
						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-info " type="button" onclick="location.href='billing/index.php?id=<?php echo $row['id'] ?>'" data-id="<?php echo $row['id'] ?>" >Edit</button>
										<button class="btn btn-sm btn-outline-info view_order" type="button" data-id="<?php echo $row['id'] ?>">View</button>
